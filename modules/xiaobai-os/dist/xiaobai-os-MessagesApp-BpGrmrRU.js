/* eslint-disable */
import { D as ge, E as Je, G as Ie, H as Y, K as w, L as Me, O as Xe, S as we, U as We, V as Ae, Y as Qe, b as ie, c as ae, gt as f, h as Z, ht as me, j as oe, k as l, l as h, m as x, mt as Q, o as T, p as _, r as L, s as e, u as n, w as _e, z as ce } from "./xiaobai-os-runtime-core.esm-bundler-x_Eikhco.js";
import { c as Be, i as he, l as le, o as se, s as ea } from "./xiaobai-os-runtime-dom.esm-bundler-DWFjb9Vy.js";
...
var sa = {
  ...
  setup(a) {
    ...
    return (y, r) => (l(), n("section", ia, [
      ...
      a.contacts.length ? (l(), n("div", va, [c.value.length ? h("", !0) : (l(), n("p", ga, "没有找到这个人。")), (l(!0), n(L, null, oe(c.value, (u) => (l(), n("button", {
        key: u.id,
        class: "messages-contact-row",
        onClick: (S) => y.$emit("select", u.id)
      }, [x(ue, {
        identity: u.id,
        name: u.name
...
}, Ra = ["src", "alt"], Pa = ["disabled", "aria-label"], Ua = {
  key: 0,
  ...
  setup(a, { emit: p }) {
    ...
    const y = w(""), r = w(!1), u = w(""), S = w(""), I = w(!1), E = T(() => s.message.payload.type === "image" ? s.message.payload.attachment : void 0), B = T(() => E.value?.path || y.value), b = w(!1), $ = w(!1), C = T(() => [
      "playing",
      "loading",
      "generating",
      "queued"
    ].includes(S.value)), M = w(!1);
    let g = !0;
    ...
    async function R() {
      ...
      if (!(!A && !s.media.voice))
        try {
          A ? (M.value = !0, await d("messages/voice/stop"), g && (S.value = "")) : (S.value = "loading", await d("messages/voice/play"));
        } catch {
          g && (A || (S.value = ""), u.value = A ? "未能确认停止，请再点一次停止。" : "语音暂时无法播放，原文仍可查看。");
        } finally {
          g && (M.value = !1);
        }
    }
    const F = s.bridge.subscribe((A) => {
      ...
      const m = A.payload;
      m.messageId === s.message.id ? S.value = m.status : m.status === "playing" && (S.value = ""), m.messageId === s.message.id && m.status === "error" && (u.value = "播放失败，点击可以重试。");
    });
    return Je(() => {
    ...
    }, "重新回复", 8, Ba)) : h("", !0)]), e("div", { class: Q(["messages-bubble", `messages-bubble-${a.message.payload.type}`]) }, [a.message.payload.type === "text" ? (l(), n("p", xa, f(a.message.payload.text), 1)) : a.message.payload.type === "image" ? (l(), n(L, { key: 1 }, [
      ...
      a.message.payload.description ? (l(), n("p", La, f(a.message.payload.description), 1)) : h("", !0),
      $.value ? (l(), ae(Ee, {
        key: 5,
      ...
      e("button", {
        ...
        disabled: M.value || !a.media.voice && !C.value,
        "aria-label": C.value ? "停止播放" : "播放语音",
        onClick: R
      }, [
        x(P, { name: C.value ? "stop" : "play" }, null, 8, ["name"]),
        e("span", { class: Q(["messages-wave", { playing: S.value === "playing" }]) }, [(l(), n(L, null, oe(16, (D) => e("i", {
          key: D,
          style: me({
            height: `${8 + D * 7 % 17}px`,
        ...
        e("small", null, f(M.value ? "停止中" : [
          "loading",
          "generating",
          "queued"
        ].includes(S.value) ? "准备中" : "语音"), 1)
      ], 8, Pa),
      a.media.voice ? h("", !0) : (l(), n("small", Ua, "开启 TTS 后可播放")),
      a.media.voice ? (l(), n("button", {
        key: 1,
        class: "messages-transcript-toggle",
        onClick: m[9] || (m[9] = (D) => I.value = !I.value)
      }, f(I.value ? "收起原文" : "查看原文"), 1)) : h("", !0),
      I.value || !a.media.voice ? (l(), n("p", qa, f(a.message.payload.transcript), 1)) : h("", !0)
    ], 64)), u.value ? (l(), n("small", Va, f(u.value), 1)) : h("", !0)], 2)], 42, Ia));
  }
}), Fa = Na, Ga = [
  "image/png",
  "image/jpeg",
...
var Ha = {
  ...
  role: "status"
}, Ja = { class: "messages-composer-line" }, Xa = ["disabled"], Wa = ["placeholder", "disabled"], Qa = ["disabled"], _a = /* @__PURE__ */ Z({
  ...
  setup(a, { emit: p }) {
    const s = a, c = p, o = Me(a, "draft"), y = T({
      get: () => o.value.text,
      set: (C) => {
        o.value = {
          ...o.value,
    ...
    let I = !0;
    async function E(C) {
      const M = C.target, g = M.files?.[0];
      if (M.value = "", !(!g || s.sending || u.value)) {
        u.value = !0, S.value = "";
        try {
          const d = await za(g);
          I && (o.value = {
          ...
          I && (S.value = d instanceof Error ? d.message : "图片读取失败，请重新选择。");
        } finally {
          I && (u.value = !1);
        }
      }
    ...
    return (C, M) => (l(), n("form", {
      ...
      o.value.image ? (l(), n("div", Ha, [
        ...
        e("span", null, [M[2] || (M[2] = e("strong", null, "待发送的图片", -1)), e("small", null, f(o.value.image.name), 1)]),
        e("button", {
          type: "button",
          class: "messages-icon-button",
          "aria-label": "移除图片",
      ...
      o.value.image ? (l(), n("p", Za, "图片将随消息发送，需要当前模型支持看图。")) : h("", !0),
      u.value || S.value ? (l(), n("p", ja, f(u.value ? "正在读取图片…" : S.value), 1)) : h("", !0),
      ...
      e("div", Ja, [
        e("button", {
          ...
          "aria-label": "选择图片",
          disabled: a.sending || u.value,
          onClick: M[0] || (M[0] = (g) => r.value?.click())
        }, [x(P, { name: "plus" })], 8, Xa),
        Y(e("textarea", {
          "onUpdate:modelValue": M[1] || (M[1] = (g) => y.value = g),
          rows: "1",
          maxlength: "4000",
  ...
  role: "status"
}, ss = { key: 0 }, ts = ["disabled"], ls = ["disabled"], ns = /* @__PURE__ */ Z({
  ...
  emits: ["retry", "discard"],
  setup(a) {
    return (p, s) => (l(), n("div", as, [a.sending ? (l(), n("span", ss, "发送中…")) : (l(), n(L, { key: 1 }, [
...
}), Ce = ns, is = 158e3, us = 128e3, Se = 6e3;
function os(a) {
...
var rs = ["aria-label", "aria-expanded"], ds = {
  ...
  setup(a) {
    ...
    xe(() => (s.value = !1, !0), () => s.value), ce(() => JSON.stringify([
      ...
      try {
        ...
        M && (o.value = !0, r.value = null);
      } finally {
        M && (c.value = !1);
      }
    }, { immediate: !0 });
    const u = T(() => aa(os(p.draft.text))), S = T(() => (r.value?.imageTokens ?? 0) + (p.draft.image ? Se : 0)), I = T(() => (r.value?.usedTokens ?? 0) + u.value + (p.draft.image ? Se : 0)), E = T(() => Math.min(1, I.value / is)), B = (b) => `${(b / 1e3).toFixed(1)}k`;
    return (b, $) => (l(), n("div", {
      class: "messages-context",
      onKeydown: $[3] || ($[3] = Be(le((C) => s.value = !1, ["stop"]), ["esc"]))
    }, [e("button", {
      type: "button",
      class: Q(["messages-context-ring", { "is-warning": I.value >= Qe(us) }]),
      style: me({ "--context-fill": `${r.value ? E.value * 360 : 0}deg` }),
      "aria-label": r.value ? `上下文：约 ${B(I.value)} / 158k` : "上下文用量",
      ...
      r.value ? (l(), n(L, { key: 0 }, [e("p", vs, "约 " + f(B(I.value)) + " / 158k", 1), e("dl", null, [
        ...
        S.value ? (l(), n(L, { key: 0 }, [$[5] || ($[5] = e("dt", null, "图片预留", -1)), e("dd", null, f(B(S.value)), 1)], 64)) : h("", !0)
      ])], 64)) : h("", !0),
      c.value ? (l(), n("p", gs, f(a.state.busy?.stage === "summarizing" ? "正在总结较早通讯…" : a.state.busy || a.state.generationActive ? "本轮结束后更新用量。" : "正在读取…"), 1)) : o.value ? (l(), n(L, { key: 2 }, [$[10] || ($[10] = e("p", { role: "status" }, "用量暂时无法读取。", -1)), e("button", {
        type: "button",
        class: "messages-secondary",
        onClick: $[2] || ($[2] = (C) => y.value++)
      }, "重试")], 64)) : h("", !0),
      $[11] || ($[11] = e("p", null, "128k 时在下次回复前自动总结，保留近期原文。", -1)),
      S.value ? (l(), n("small", ms, "图片按每张 6k 预留，实际用量由模型决定。")) : h("", !0)
    ])) : h("", !0)], 32));
  }
  ...
  key: 0,
  class: "messages-time"
}, hs = { class: "messages-bubble-row outgoing" }, Cs = { key: 0 }, Ss = ["src", "alt"], Is = {
  key: 0,
  class: "messages-image-caption"
}, Ms = {
  key: 3,
  ...
  setup(a, { expose: p }) {
    ...
    _e(() => {
      ...
      const d = new Set(c.page.messages.map((R) => R.id)), k = [...g.querySelectorAll("[data-message-id]")].find((R) => d.has(R.dataset.messageId) && R.getBoundingClientRect().bottom > g.getBoundingClientRect().top);
      k && (b = {
    ...
    async function C() {
      await we(), E && !B && !c.page.hasNewer && I.value && (I.value.scrollTop = I.value.scrollHeight);
    }
    ce(() => [
    ...
    return p({ sent() {
      ...
      e("div", {
        ...
        (l(!0), n(L, null, oe(a.page.messages, (k, R) => (l(), n(L, { key: k.id }, [
          R === 0 || k.createdAt - a.page.messages[R - 1].createdAt > 3e5 ? (l(), n("time", ws, f(new Date(k.createdAt).toLocaleString(void 0, {
            month: "numeric",
            day: "numeric",
            hour: "2-digit",
            minute: "2-digit"
        ...
        a.outgoing ? (l(), n(L, { key: 2 }, [e("div", hs, [e("div", { class: Q(["messages-bubble", { "messages-bubble-image": a.outgoing.payload.type === "image" }]) }, [a.outgoing.payload.type === "text" ? (l(), n("p", Cs, f(a.outgoing.payload.text), 1)) : (l(), n(L, { key: 1 }, [e("img", {
          class: "messages-pending-image",
          src: a.outgoing.payload.upload.dataUrl,
          alt: a.outgoing.payload.upload.name,
          onLoad: C
        }, null, 40, Ss), a.outgoing.payload.description ? (l(), n("p", Is, f(a.outgoing.payload.description), 1)) : h("", !0)], 64))], 2)]), x(Ce, {
        ...
        u.value ? (l(), n("div", Ms, [...d[11] || (d[11] = [e("span", null, [
          e("i"),
          e("i"),
          e("i")
        ], -1), _("对方正在输入…", -1)])])) : h("", !0)
      ...
      a.page.hasNewer ? (l(), n("button", {
        ...
        onClick: d[8] || (d[8] = (k) => {
          We(E) ? E.value = !0 : E = !0, g.$emit("latest");
        })
      }, "回到最新消息")) : h("", !0),
      x(es, {
        draft: s.value,
...
var Es = { class: "messages-app" }, Ds = {
  ...
  role: "status"
}, Ts = { class: "messages-save-actions" }, Ls = ["disabled"], Rs = ["disabled"], Ps = {
  key: 1,
  class: "messages-banner",
  role: "status"
}, Us = ["disabled"], qs = {
  ...
  class: "messages-error",
  role: "alert"
}, Ks = { class: "messages-search" }, Os = ["aria-busy"], Zs = {
  key: 0,
  class: "messages-subtle",
  role: "status"
}, js = { key: 1 }, Ys = ["disabled"], Js = ["disabled", "onClick"], Xs = { key: 0 }, Ws = {
  key: 0,
  class: "messages-subtle"
}, Qs = { class: "messages-manual" }, _s = ["disabled"], et = ["disabled"], at = ["disabled"], st = {
  key: 0,
  role: "status"
}, tt = { key: 1 }, lt = ["disabled"], nt = {
  key: 0,
  role: "status"
}, it = { key: 1 }, ut = ["disabled"], ot = ["disabled"], rt = { class: "messages-manual" }, dt = ["disabled"], vt = ["disabled"], gt = ["disabled"], mt = ["disabled"], ct = /* @__PURE__ */ Z({
  __name: "MessagesApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(a) {
    const p = a, s = w(p.initialState), c = (i = "") => ({
      ...
      revision: "",
      permissions: {}
    }), o = w(""), y = w(c()), r = w(!1), u = w(!1), S = w(""), I = w(""), E = w(null), B = w(!1), b = w("add"), $ = w(""), C = w(""), M = T(() => b.value === "delete" ? H.value?.deleteReason ?? "" : y.value.permissions[$.value]?.reason ?? ""), g = w(""), d = w(""), k = w(""), R = w("ready"), F = w(ve());
    let A = !0, m = 0;
    const D = Ie(/* @__PURE__ */ new Map()), ye = T({
      get: () => D.get(o.value) ?? xs(),
      set: (i) => {
        D.set(o.value, i);
      }
    }), U = w(null), j = w(null), W = T(() => s.value.outgoing ?? U.value), De = T(() => W.value?.contactId === o.value && !y.value.messages.some((i) => i.id === W.value?.messageId) ? W.value : null), H = T(() => s.value.contacts.find((i) => i.id === o.value)), Te = T(() => s.value.busy && s.value.busy.contactId !== o.value ? s.value.contacts.find((i) => i.id === s.value.busy?.contactId)?.name ?? "另一位联系人" : ""), te = T(() => s.value.pendingSave || s.value.pendingModification || [
      "unconfirmed",
      "conflict",
      "failed"
    ...
    async function J(i = !1, t = !1) {
      const v = o.value;
      if (!v) return;
      const z = ++m;
      r.value = !0, I.value = "";
      try {
        const O = y.value, X = await q("messages/thread", {
          contactId: v,
          ...i ? {
        ...
        if (!A || z !== m || o.value !== v || X.revision !== s.value.revision) return;
        const re = i && O.revision === X.revision, de = re ? [...X.messages, ...O.messages].slice(0, 100) : X.messages;
        y.value = {
          ...X,
          messages: de,
          hasNewer: re ? de.at(-1)?.id !== O.messages.at(-1)?.id || O.hasNewer : X.hasNewer,
          permissions: re ? {
            ...O.permissions,
            ...X.permissions
          } : X.permissions
        ...
        A && z === m && o.value === v && (I.value = "消息暂时无法读取。");
      } finally {
        z === m && (r.value = !1);
      }
    }
    function V(i) {
      ...
      U.value && !i.contacts.some((v) => v.id === U.value?.contactId) && (U.value = null, j.value = null), o.value && !i.contacts.some((v) => v.id === o.value) ? ne() : o.value && t && J();
    }
    const Le = p.bridge.subscribe((i) => {
      i.type === "messages/state" && V(i.payload.state);
    });
    function fe(i) {
      o.value = i, S.value = "", y.value = c(i), J();
    }
    function ne() {
      o.value = "", m++, I.value = "", y.value = c();
    }
    xe(() => (ne(), !0), () => !!o.value);
    async function K(i) {
      if (!u.value) {
        ...
        try {
          ...
          A && (S.value = t instanceof Error && t.message !== "host_request_timeout" ? t.message : "暂时没收到操作结果，请先检查保存再重试。");
        } finally {
          u.value = !1;
        }
      }
    ...
    async function pe(i, t, v) {
      if (!u.value) {
        u.value = !0, j.value = null, S.value = "";
        try {
    ...
    function Pe(i) {
      const t = W.value?.messageId === i ? W.value : void 0;
      pe(o.value, i, t);
    }
    function Ue(i) {
      K(async () => {
        V(await q("messages/discard-send", { messageId: i })), U.value?.messageId === i && (U.value = null), j.value = null, await J();
      });
    }
    function qe(i) {
      K(async () => V(await q(i)));
    ...
    function ee(i) {
      b.value = i, S.value = "", g.value = "", d.value = H.value?.note ?? "", k.value = "", F.value = ve(), B.value = !0, C.value = s.value.revision, i === "add" && ke();
    }
    async function ke() {
    ...
    function $e(i = g.value) {
      !i.trim() || N.value || R.value === "loading" || K(async () => {
    ...
    function je() {
      K(async () => {
        V(await q("messages/adopt-server-state")), s.value.fileState === "ready" && !s.value.pendingSave ? (U.value = null, j.value = null, G()) : S.value = "暂时无法加载已保存版本，请检查网络后重试。当前记录未改。";
      });
    }
    return ge(() => {
      A = !1, m++, Le();
      ...
      }, "检查保存", 8, Ls), s.value.fileState === "conflict" ? (l(), n("button", {
        key: 0,
        disabled: u.value || !!s.value.busy || s.value.generationActive,
        onClick: t[1] || (t[1] = (v) => ee("adopt"))
      }, "使用已保存版本", 8, Rs)) : h("", !0)])])) : s.value.unsynced && !s.value.busy ? (l(), n("div", Ps, [e("span", null, f(s.value.unsynced) + " 条消息已保留，尚未写入主聊天。", 1), e("button", {
        disabled: N.value,
        onClick: t[2] || (t[2] = (v) => ee("sync"))
      }, "查看", 8, Us)])) : h("", !0),
      s.value.generationActive ? (l(), n("div", qs, "故事正在继续，稍后就能发送消息。")) : h("", !0),
      S.value || s.value.error ? (l(), n("p", Vs, f(S.value || s.value.error), 1)) : h("", !0),
      I.value ? (l(), n("div", Ns, [e("span", null, f(I.value), 1), e("button", {
        disabled: r.value,
        onClick: t[3] || (t[3] = (v) => J())
      }, "重新加载", 8, Fs)])) : h("", !0),
      H.value ? (l(), ae(Bs, {
      ...
      B.value ? (l(), ae(Ee, {
        ...
        default: Ae(() => [
          ...
          S.value ? (l(), n("p", Hs, f(S.value), 1)) : h("", !0),
          b.value === "settings" ? (l(), ae(Sa, {
            key: 1,
            settings: s.value.settings,
            busy: u.value || !!s.value.busy,
            onSave: Ve
          }, null, 8, ["settings", "busy"])) : b.value === "add" ? (l(), n(L, { key: 2 }, [
            e("label", Ks, [x(P, { name: "search" }), Y(e("input", {
            ...
            e("div", {
              ...
              "aria-busy": R.value === "loading"
            }, [R.value === "loading" ? (l(), n("p", Zs, "正在读取已知人物…")) : R.value === "failed" ? (l(), n("div", js, [t[17] || (t[17] = e("p", {
              class: "messages-subtle",
              role: "alert"
              ...
              disabled: u.value,
              onClick: ke
            }, "重新加载", 8, Ys)])) : (l(), n(L, { key: 2 }, [(l(!0), n(L, null, oe(be.value, (v) => (l(), n("button", {
              key: v.name,
              disabled: N.value,
              onClick: (z) => $e(v.name)
            }, [
              ...
              e("span", null, [_(f(v.name), 1), v.aliases.length ? (l(), n("small", Xs, f(v.aliases.join("、")), 1)) : h("", !0)]),
              x(P, { name: "plus" })
            ], 8, Js))), 128)), be.value.length ? h("", !0) : (l(), n("p", Ws, f(k.value ? "没有匹配的人物，可以在下面手动添加。" : "暂无可添加的已知人物，可以在下面手动添加。"), 1))], 64))], 8, Os),
            e("details", Qs, [t[20] || (t[20] = e("summary", null, "想联系的人不在这里？", -1)), e("form", { onSubmit: t[12] || (t[12] = le((v) => $e(), ["prevent"])) }, [
              ...
              e("button", {
                class: "messages-primary",
                disabled: N.value || R.value === "loading" || !g.value.trim()
              }, "添加并聊天", 8, _s)
            ], 32)])
          ...
          ], 32)) : b.value === "delete" ? (l(), n(L, { key: 4 }, [
            M.value ? (l(), n("p", st, f(M.value), 1)) : (l(), n("p", tt, "删除与 " + f(H.value?.name) + " 的全部通讯和摘要，同时更新主聊天记录。其他联系人和图库文件保留，删除后不能恢复。", 1)),
            e("button", {
              class: "messages-danger",
          ...
          ], 64)) : b.value === "delete-message" ? (l(), n(L, { key: 5 }, [
            M.value ? (l(), n("p", nt, f(M.value), 1)) : (l(), n("p", it, "删除这条消息，同时更新主聊天记录。后续回复、其他消息和图库文件保留，删除后不能恢复。")),
            e("button", {
              class: "messages-danger",
              disabled: N.value || !!M.value,
              onClick: Ke
