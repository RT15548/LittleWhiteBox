/* eslint-disable */
import { A as l, B as me, E as ye, F as fe, G as Re, J as oe, K as d, L as te, M as L, N as Le, O as ue, T as Ee, U as q, Y as h, _ as Te, b as T, c as Me, f as w, g as o, h as f, l as ie, m as N, o as ze, p as t, q as Q, s as Se, u as B, v as R, y as $, z as ce } from "./xiaobai-os-runtime-dom.esm-bundler-ASdQr4iS.js";
import { n as Oe } from "./xiaobai-os-app-navigation-DrBJz_Kq.js";
import { t as je } from "./xiaobai-os-AppDialog-CV8GB57a.js";
import { a as Qe, b as De, c as Ze, d as Ue, f as Be, g as Ne, h as We, i as He, l as Ye, n as Fe, o as Xe, p as $e, r as qe, s as Ge, u as we, v as se, x as Je, y as et } from "./xiaobai-os-map-presentation-DmLs9dcB.js";
var tt = { class: "map-viewport" }, at = ["viewBox", "aria-label"], lt = {
  ...
  setup(s) {
    ...
    let p = null, c = [0, 0], e = 0, g = null, V = !1, E = !1, z = null;
    ...
    function Z(y) {
      y.button !== 0 || r.size >= 2 || (r.size || (V = !1), r.set(y.pointerId, [y.clientX, y.clientY]), y.target.setPointerCapture(y.pointerId), O());
    }
    function K(y) {
    ...
    function U(y) {
      ...
      const M = y.target;
      M.hasPointerCapture(y.pointerId) && M.releasePointerCapture(y.pointerId), O(), r.size || (p = null, g = null), V && (E = !0, z && clearTimeout(z), z = setTimeout(() => {
        E = !1;
      }, 0));
    }
    function I(y) {
    ...
    return te(() => n.resetKey, A, { immediate: !0 }), te(() => n.focusSequence, D, { flush: "post" }), ye(() => {
      ...
      onPointercancel: U,
      onClickCapture: I
    }, [Le(y.$slots, "default", { unitScale: k.value })], 40, at)), t("div", lt, [
      t("button", {
        type: "button",
        "aria-label": "放大地图",
    ...
    return (r, p) => (l(), N(Ke, {
      ...
      default: ce(({ unitScale: c }) => [
        ...
        t("g", ct, [(l(!0), o(B, null, L(i.value.nodes, (e) => (l(), o("g", {
          ...
          class: Q(`is-${e.location.terrain || "urban"}`)
...
var wt = ["id"], xt = ["stop-color", "stop-opacity"], _t = ["stop-color", "stop-opacity"], Ct = ["stop-color", "stop-opacity"], St = ["id"], jt = ["fill", "fill-opacity"], Bt = {
  ...
  "stroke-width": ".7",
  opacity: ".35"
}, Qt = ["id"], Dt = ["id"], Zt = ["transform", "fill"], Ut = /* @__PURE__ */ T({
    ...
    return (n, i) => (l(), o("defs", null, [
      (l(!0), o(B, null, L(d(Je), (a) => (l(), o(B, { key: a }, [t("linearGradient", {
        ...
        t("g", Bt, [a === "wood" ? (l(), o(B, { key: 0 }, [i[0] || (i[0] = t("path", { d: "M0 0H48M0 16H48M19 0V16M37 16V32" }, null, -1)), i[1] || (i[1] = t("path", {
          ...
          "bed-sheet",
          "tatami"
        ].includes(a) ? (l(), o("path", Lt)) : a === "rune" ? (l(), o("path", Et)) : a === "blood" ? (l(), o("path", Tt)) : a === "snow" ? (l(), o("path", zt)) : f("", !0)]),
        a === "wood" || a === "stone" || a === "metal" ? (l(), o("path", Ot)) : f("", !0)
      ], 8, St)], 64))), 128)),
      t("radialGradient", {
  ...
  setup(s) {
    ...
    return (c, e) => (l(), o("svg", {
      ...
      class: "scene-object"
    }, [t("defs", null, [t("clipPath", { id: p }, [v.value ? (l(), o("circle", Yt)) : (l(), o("rect", Ft))])]), t("g", {
      "clip-path": `url(#${p})`,
      fill: m.value
      ...
      class: "scene-object-shine"
    }, null, -1))], 64)) : f("", !0)], 64)) : f("", !0)], 8, Xt)], 8, Wt));
  }
  ...
  setup(s) {
    ...
    const a = `xiaobai-map-scene-${fe()}`, v = w(() => qe[n.scene.mood || "neutral"]), k = w(() => Ge(n.scene.elements)), m = w(() => Xe(n.scene.elements).map((r, p) => ({
      element: r,
      bounds: Be(r),
      path: We(r),
      transform: Ne(r),
    ...
    return (r, p) => (l(), N(Ke, {
      ...
      default: ce(({ unitScale: c }) => [
        ...
        (l(!0), o(B, null, L(m.value, (e) => (l(), o("g", {
          key: e.element.id,
          class: Q(["map-scene-element", [`is-${e.element.category}`, `is-${e.element.certainty || "confirmed"}`]]),
          ...
          e.object && !d(Ze)(e.element) && Math.min(e.bounds.width, e.bounds.height) / c >= 12 ? (l(), o("g", {
            ...
            class: Q(i.value ? "map-material-symbol" : "map-symbol-fallback"),
            style: oe({
        ...
        t("g", {
          ...
          key: 0,
          class: Q(["map-scene-label", { "is-primary": e.element.shape === "label" }]),
          x: d($e)(e.element, c)[0],
          y: d($e)(e.element, c)[1]
  ...
  setup(s, { emit: n }) {
    ...
    return ue(async () => {
      p = !0;
      try {
        const { createThreeRuntime: c } = await import("./xiaobai-os-three-runtime-CimlFYon.js");
        if (!p) return;
    ...
    }), te(() => i.scene, (c) => r?.setScene(c)), te(() => i.lowWalls, (c) => r?.walls(c)), te(() => i.showLabels, (c) => r?.labels(c)), ye(() => {
  ...
  setup(s, { emit: n }) {
    ...
    ]), t("div", Ra, [me($(_a, { scene: s.scene }, null, 8, ["scene"]), [[Se, s.mode === "2d"]]), s.mode === "3d" ? (l(), N(Ba, {
      key: 0,
      scene: s.scene,
      "low-walls": a.value,
      "show-labels": v.value,
...
var Ta = { class: "map-dialog-header" }, za = { key: 0 }, Oa = { class: "map-settings-content" }, Qa = { class: "map-auto-setting" }, Da = ["aria-checked", "disabled"], Za = { class: "map-settings-section" }, Ua = ["disabled"], Na = { key: 0 }, Wa = { class: "map-settings-section" }, Ya = { key: 0 }, Fa = ["disabled"], Xa = {
  key: 0,
    ...
    return (n, i) => (l(), N(je, {
      ...
      default: ce(() => [
        ...
        s.status || s.notice || s.maintenanceMessage ? (l(), o("section", {
          key: 0,
          class: Q(["map-settings-feedback", { "is-error": s.notice ? s.noticeError : s.maintenanceError }]),
          role: "status"
        ...
        t("div", Oa, [
          t("section", Qa, [i[8] || (i[8] = t("div", null, [t("h3", null, "随对话自动更新"), t("p", null, "你发送下一条消息时，根据上一轮对话更新地图。适用于所有普通聊天。")], -1)), t("button", {
            type: "button",
            class: "map-switch",
            role: "switch",
          ...
          t("section", Wa, [
            ...
            }, h(s.busy ? s.status || "请稍候…" : s.hasMap ? "重新绘制" : "绘制世界地图"), 9, Fa)
          ]),
          s.disabledReason ? (l(), o("p", Xa, h(s.disabledReason), 1)) : f("", !0),
          t("button", {
            type: "button",
    ...
    return (r, p) => (l(), o("section", dl, [
      ...
      t("div", pl, [
        ...
        k.value.length ? (l(), o("section", gl, [p[5] || (p[5] = t("h3", null, "相连的地方", -1)), (l(!0), o(B, null, L(k.value, (c) => (l(), o("button", {
          ...
          $(j, { name: "route" }),
          t("span", null, [t("strong", null, h(c.location.name), 1), t("small", null, h(c.link.label || d(Fe)[c.link.kind]) + h(c.link.bidirectional ? "" : c.outgoing ? " · 单向前往" : " · 仅可从对面到达"), 1)]),
          $(j, { name: "next" })
        ], 8, Ml))), 128))])) : f("", !0),
...
function xl(s) {
  ...
  async function P(C, H, D = {}) {
    if (i.value) return;
    const O = ++m, Z = r, K = n.value.chatIdentity;
    ...
    try {
      ...
      if (!k || O !== m || n.value.chatIdentity !== K) return;
      ...
      k && O === m && n.value.chatIdentity === K && (a.value = A(U, H), v.value = !0);
    } finally {
      k && O === m && (i.value = null);
    }
  }
...
var _l = { class: "map-top" }, Cl = { class: "map-search-bar" }, Sl = ["disabled"], jl = {
  ...
  class: "map-notice",
  role: "status"
}, El = ["disabled"], Tl = ["disabled"], zl = ["disabled"], Ol = {
  key: 1,
  class: "map-empty"
}, Ql = ["disabled"], Dl = {
  key: 0,
  ...
  key: 1,
  class: "map-setting-note"
}, Fl = ["disabled"], Xl = ["aria-expanded"], Gl = {
  key: 1,
  class: "map-key"
}, Jl = {
  key: 3,
  ...
  setup(s) {
    const { state: n, activeRequest: i, busy: a, disabledReason: v, requiresConfirmation: k, status: m, notice: r, isError: p, dismissNotice: c, refresh: e, confirmSave: g, adopt: V, setAuto: E, update: z, rebuild: Y } = xl(s), A = q(n.value.map ? xe(n.value.map.atlas) : ""), P = q(""), C = q(_e(n.value.map) === "scene" ? "" : null), H = q("3d"), D = q(!1), O = q("");
    let Z = !1;
    const K = w(() => C.value !== null), U = q(""), I = q(0), y = q(!1), M = q(!1), x = q(!1), S = w(() => n.value.map?.atlas), W = w(() => S.value?.actors.find((_) => _.actorKey === "player")?.locationKey || ""), F = w(() => S.value?.locations.find((_) => _.key === W.value)), G = w(() => S.value?.locations.find((_) => _.key === P.value)), J = w(() => S.value?.locations.find((_) => _.key === (C.value || W.value))), be = w(() => K.value && J.value?.sceneKey ? n.value.map?.scenes[J.value.sceneKey] : void 0), de = w(() => S.value?.locations.find((_) => _.key === A.value)), ve = w(() => S.value?.locations.filter((_) => (_.parent || "") === A.value) || []), ke = w(() => ve.value.filter((_) => _.status !== "visited").length), Ve = w(() => S.value ? he(S.value, A.value) : []);
    te(() => n.value, (_, u) => {
      const b = _.chatIdentity !== u.chatIdentity;
      (!u.map || b || A.value && !_.map?.atlas.locations.some((X) => X.key === A.value)) && (A.value = _.map ? xe(_.map.atlas) : ""), (b || !_.map?.atlas.locations.some((X) => X.key === P.value)) && (P.value = ""), b && (Z = !1), (b || !u.map?.atlas.locations.length && _.map?.atlas.locations.length && !Z || C.value && !_.map?.atlas.locations.some((X) => X.key === C.value)) && (C.value = _e(_.map) === "scene" ? "" : null), b && (y.value = !1, M.value = !1);
    });
    function ae(_) {
    ...
    function Ie(_) {
      D.value || (D.value = !0, H.value = "2d", O.value = _);
    }
    return Oe(() => x.value ? (x.value = !1, !0) : K.value ? (ge(), !0) : P.value ? (P.value = "", !0) : A.value ? (ae(de.value?.parent || ""), !0) : !1), (_, u) => (l(), o("main", { class: Q(["map-app", {
      ...
      t("div", _l, [
        ...
        O.value ? (l(), o("aside", Ll, [t("p", null, h(O.value), 1), t("button", {
          type: "button",
          class: "map-notice-close",
          "aria-label": "关闭三维提示",
          onClick: u[6] || (u[6] = (b) => O.value = "")
        }, [$(j, { name: "close" })])])) : f("", !0),
        d(r) || d(k) || d(n).status === "conflict" ? (l(), o("aside", {
          key: 4,
          class: Q(["map-notice", { "is-error": d(p) }]),
          role: "status"
      ...
      t("div", { class: Q(["map-canvas", { "has-detail": G.value && !K.value }]) }, [d(n).map && S.value?.locations.length ? (l(), o(B, { key: 0 }, [
        me($($t, {
          atlas: d(n).map.atlas,
          region: A.value,
      ...
      S.value?.locations.length && !K.value ? (l(), o("div", {
        key: 0,
        class: Q(["map-floating-tools", { "has-detail": G.value }])
      }, [t("button", {
        type: "button",
        class: "map-round-button",
        disabled: !F.value,
        "aria-label": "回到我的位置",
        onClick: Ae
      }, [$(j, { name: "locate" })], 8, Fl), t("button", {
        type: "button",
        class: "map-round-button",
        "aria-expanded": x.value,
        "aria-label": "地图图例",
        onClick: u[16] || (u[16] = (b) => x.value = !x.value)
      }, [$(j, { name: "layers" })], 8, Xl)], 2)) : f("", !0),
